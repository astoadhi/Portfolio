...
- ### Machine Learning
  - [Credit Risk Classification](https://github.com/astoadhi/Credit-Risk-Classification) : predicting the loan status (default or non-default) based on the given features
- ### Projects
  - _MATLAB_
